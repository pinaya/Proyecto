            ...
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="formulario">
                                <h1 class="h3">CAJA TIPO MALETA</h1>
                                <p class="h3 py-2">Bs. 29.20 / unid</p>
                                ...
                                <ul class="list-inline">
                                    ...
                                    <li class="list-inline-item">
                                        <p class="text-muted"><strong>35x50x40 (ancho x largo x alto)</strong></p>
                                    </li>
                                    <h6>Descripcion:</h6>
                                    <p>Se utiliza para el transporte de items que se pueden llevar en una mano.
                                    </p>
                ...
                <div class="col-lg-7 mt-5">
                    ...
                    <script>
                        ...
                        const createScene = () => {
                            ...
                            BABYLON.SceneLoader.Append("assets/3dmodels/", "cajaMaleta.glb", scene, function () {
